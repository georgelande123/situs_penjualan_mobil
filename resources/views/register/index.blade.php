          ...
          <h1 class="h3 mb-3 fw-normal text-center">Registration Form</h1>
            <form action="/register" method="post">
              ...
              <div class="form-floating">
                <input type="text" name="name" class="form-control rounded @error('name')
            ...
            <small class="d-block text-center mt-3">Already registred?
              <a href="/login">Register Now!</a></small>
        </main>
